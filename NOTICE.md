...
`eval-b3` packages an evaluation from **inspect_evals**.

- **Upstream:** https://github.com/UKGovernmentBEIS/inspect_evals (`src/inspect_evals/b3`)
...
- `huggingface`: `Lakera/b3-agent-security-benchmark-weak`
