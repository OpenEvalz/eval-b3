#!/usr/bin/env python3
"""Run ONE problem of b3 through TrustedRouter and emit a reproducibility bundle.
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Run one b3 problem via TrustedRouter")
